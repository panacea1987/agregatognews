...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            <form method="get" id="singlenews" action="/singlenews/">
                <p class="clearfix">
                    <label for="urlsite">Искать новость по ключевому слову:</label>
                    <input type="text" name="keyword" id="urlsite" placeholder="search" required>
                    <input type="submit" name="submit" value="Искать" form="singlenews" class="b4">
                </p>
            </form>
        </div>
    </div>
